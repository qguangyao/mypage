...
export default (props:any) => {
        ...
        <Sider className="styles.site-layout-background"  width={200}>
          ...
          >
            <SubMenu key="sub1" icon={<UserOutlined />} title="娱乐">
              <Menu.Item key="1"><Link to="/toy/worktime">工作时间</Link></Menu.Item>
            </SubMenu>
            <SubMenu key="sub2" icon={<LaptopOutlined />} title="工具">
              <Menu.Item key="5">计算器</Menu.Item>
            </SubMenu>
            <SubMenu key="sub3" icon={<NotificationOutlined />} title="关于我">
              <Menu.Item key="9">简介</Menu.Item>
            </SubMenu>
          </Menu>
        </Sider>
  ...
  <Footer style={{ textAlign: 'center', position: 'fixed' ,bottom:'0' , width:'100%'  }}>{footText}</Footer>
  </Layout>
  );
}
